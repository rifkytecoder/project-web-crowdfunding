...
func (r *repository) FindByUserID(userID int) ([]Campaign, error) {
	...
	// preload `load data dengan filtering`
...
// mengambil data campaign dgn ID
...
// mengubah nilai field is_primary menjadi false
